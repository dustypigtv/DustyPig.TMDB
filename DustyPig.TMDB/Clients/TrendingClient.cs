...
internal class TrendingClient : ITrending
{
    ...
    public Task<Response<PagedResult<MediaObject>>> GetAllAsync(Timewindow timeWindow = Timewindow.Day, string language = "en-US", CancellationToken cancellationToken = default)
    {
        ...
        return _client.GetAsync<PagedResult<MediaObject>>($"/3/trending/all/{timeWindow}", queryParams, cancellationToken);
    }
    ...
    /// </summary>
    /// <param name="language">`ISO-639-1`-`ISO-3166-1` code</param>
    public Task<Response<PagedResult<MediaObject>>> GetMoviesAsync(Timewindow timeWindow = Timewindow.Day, string language = "en-US", CancellationToken cancellationToken = default)
    {
        var queryParams = new Dictionary<string, object>
        {
            { "language", language }
        ...
        return _client.GetAsync<PagedResult<MediaObject>>($"/3/trending/movie/{timeWindow}", queryParams, cancellationToken);
    }
