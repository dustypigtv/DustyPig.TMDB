...
internal class TvSeasonsClient : ITvSeasons
{
    ...
    public Task<Response<CommonImages>> GetImagesAsync(int seasonNumber, int seriesId, string includeImageLanguage = null, string language = "en-US", CancellationToken cancellationToken = default)
    {
        ...
        return _client.GetAsync<CommonImages>($"/3/tv/{seriesId}/season/{seasonNumber}/images", queryParams, cancellationToken);
    }

    /// <summary>
    /// Get the translations for a TV season.
    /// </summary>
    public Task<Response<CommonTranslationList<CommonTranslation<CommonTranslationData>>>> GetTranslationsAsync(int seasonNumber, int seriesId, CancellationToken cancellationToken = default) =>
        _client.GetAsync<CommonTranslationList<CommonTranslation<CommonTranslationData>>>($"/3/tv/{seriesId}/season/{seasonNumber}/translations", null, cancellationToken);
